...
const {cart}=this.state
  ...
  return(<div  class="container jumbotron" >
   <h1 style={{textAlign:"center",fontFamily: "Amatic SC",fontWeight:"bolder",letterSpacing:"5px"}}>MENU </h1>  
...
<article id="article-card" style={{padding:"0px 2px 4px 2px",marginBottom:"7px"}} >
       ...
       <section style={{display:"flex",flexDirection:"column",flexWrap:"wrap"}} className="Prices"> <h2 style={{flexGrow:"2",backgroundColor:"MediumSeaGreen",textAlign:"center"}}>{v.name} </h2> 
